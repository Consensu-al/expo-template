...
// Create the store with persistence using our AsyncStorage adapter
const useCounterStore = create<CounterState>()(
  persist(
    ...
    }),
    {
      ...
      storage: createJSONStorage(() => createAsyncStorage("counter")),
    }
  )
);
...
export default function AsyncStorageExample() {
  ...
  return (
    <Card style={styles.card}>
      <Card.Title title="AsyncStorage Persistence Example" />
      <Card.Content>
        <Text style={styles.description}>
          This component demonstrates using Zustand with AsyncStorage persistence.
          The counter value is persisted in AsyncStorage and will be restored across app restarts.
        </Text>
